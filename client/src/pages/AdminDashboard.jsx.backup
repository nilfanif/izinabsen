                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{submission.employeeNip} - {submission.department}</p>
                      </div>
                    ...
                    <div className="mt-3 space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          {submission.type === 'tidak-rekam' ? (
                            <div className="w-8 h-8 bg-primary-100 rounded-lg flex items-center justify-center">
                              <XCircle className="w-4 h-4 text-primary-600" />
                            </div>
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-600">
                        <span className="flex items-center gap-1">
                          ...
                          Tanggal: {format(new Date(submission.date), 'dd MMMM yyyy', { locale: id })}
                        </span>
                        <span className="flex items-center gap-1">
                          <Clock className="w-4 h-4" />
                          Diajukan: {format(new Date(submission.submittedAt), 'dd MMM yyyy HH:mm', { locale: id })}
                        </span>
                      </div>
                      ...
                      {submission.reason && (
                        <div>
                          ...
                          <span className="text-sm text-gray-600 capitalize">{submission.reason.replace('-', ' ')}</span>
                        </div>
                      )}
                      
                      <div>
                        <span className="text-sm font-medium text-gray-700">
                          {submission.type === 'terlambat-rekam' ? 'Alasan Terlambat: ' : submission.type === 'lupa-rekam' ? 'Alasan Lupa Rekam: ' : 'Keterangan: '}
                        </span>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium text-gray-700">
                              {submission.status === 'approved' ? 'Disetujui' : 'Ditolak'} oleh {submission.reviewedBy}
                            </p>
                            <p className="text-sm text-gray-600 mt-1">{submission.reviewNote}</p>
                            <p className="text-xs text-gray-500 mt-1">
                              {format(new Date(submission.reviewedAt), 'dd MMM yyyy HH:mm', { locale: id })}
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">NIP: {registration.nip}</p>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-3">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-900">{registration.username}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-900">{registration.position}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <Building2 className="w-4 h-4 text-gray-400 mt-0.5" />
                          <div>
                            <p className="text-xs text-gray-500">Bagian/Bidang</p>
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <div className="flex items-center gap-2 text-xs text-gray-500">
                          <Calendar className="w-4 h-4" />
                          <span>Mendaftar: {format(new Date(registration.created_at), 'dd MMM yyyy HH:mm', { locale: id })}</span>
                        </div>
                      </div>
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1">
                              ...
                              {registration.review_note && (
                                <p className="text-sm text-gray-600 mt-1">{registration.review_note}</p>
                              )}
                              <p className="text-xs text-gray-500 mt-1">
                                {format(new Date(registration.reviewed_at), 'dd MMM yyyy HH:mm', { locale: id })}
                              </p>
                            </div>
                          </div>
                        </div>
